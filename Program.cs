...
namespace ArdupilotMega
{
   ...
   //                 WebRequest request = WebRequest.Create("http://vps.oborne.me/mail.php");
                    WebRequest request = WebRequest.Create("http://dronemetrex.support/mail.php");
                    /////////////  Need to change request adrress to one that exists /////////////
                ...
                {
                    CustomMessageBox.Show("Error sending Error report! Your most likely not connected to the internet");
                }
            }
        }
