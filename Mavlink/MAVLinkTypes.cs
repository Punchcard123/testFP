...
namespace ArdupilotMega
{
    ...
    partial class MAVLink
    {
        ...
        public enum MAV_CMD
        {
            ...
            ///<summary> Set Pre Launch Throttle PWM value, use a value of 0 for hand launch | PWM (microseconds, 0 or 1250 typical)| Empty| Empty| Empty| Empty| Empty| Empty|  </summary>
            DO_SET_PRELAUNCH_THROTTLE = 222,
