    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            st.WriteLine(@"""C:\Program Files\7-Zip\7z.exe"" a -tzip -xr!*.log -xr!DmxMissionPlanner.log* -xr!*.tlog -xr!config.xml -xr!gmapcache -xr!eeprom.bin -xr!dataflash.bin -xr!*.new ""Mission Planner " + fvi.FileVersion + @".zip"" ..\bin\release\*");
...
data = @"
    ...
    <CustomAction Id=""LaunchApplication"" 
        ...
        static void dodirectory(string path, int level = 1)
        {
            ...
            {
                if (filepath.ToLower().EndsWith("release\\config.xml") || filepath.ToLower().Contains("DmxMissionPlanner.log") || 
