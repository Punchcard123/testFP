...
namespace ArdupilotMega.GCSViews
{
    partial class FlightPlanner : MyUserControl, IDeactivate, IActivate
    {
        ...
        public FlightPlanner()
        {
            ...
            // config map             
            //MainMap.MapType = MapType.GoogleSatellite;  // was commented out..Seems to ignore this statement anyway?  12/11/2013
            MainMap.MinZoom = 1;
        ...
        {
            string place = "Adelaide Airport, Australia";
            zoomToToolLocation(ref place);
        ...
        public GeoCoderStatusCode zoomToToolLocation(ref string placename)
        {
            string place;
            ...
            if (DialogResult.OK == Common.InputBox("Location", "Enter your location", ref place))
            {
                status = MainMap.SetCurrentPositionByKeywords(place);
                if (status != GeoCoderStatusCode.G_GEO_SUCCESS)
                {
                    CustomMessageBox.Show("Google Maps Geocoder can't find: '" + place + "', reason: " + status.ToString(), "GMap.NET", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
        ...
        {
            ProjectCalculator form = new ProjectCalculator();
